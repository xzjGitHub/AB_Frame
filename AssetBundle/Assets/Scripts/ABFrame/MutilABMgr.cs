...
public class MutilABMgr
{
    ...
    private string m_currentScenesName;
    ...
    public MutilABMgr(string scenesName,string abName,LoadComplete loadCompleteHandle)
    {
        m_currentScenesName = scenesName;
    ...
    public UnityEngine.Object LoadAsset(string abName,string assetName,bool isCache)
    {
        ...
        {
            Debug.LogError("加载资源出错,资源名: " + assetName + "  ab包名:" + abName);
            return null;
        }
    }
